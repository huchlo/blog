...
# 邮件（JavaMail）
[Releases · javaee/javamail · GitHub](https://github.com/javaee/javamail/releases)
## 创建邮件
```java
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 8. 将该邮件保存到本地，保存的 MyEmail.eml 可以使用邮件客户端打开查看，实际上就是一堆符合SMTP协议格式的文本（内容使用base64进行了编码），也可用记事本打开
