...
# 切换支付
##### 配置支付提现平台 
/data/app/SGame/CommConfigData/GameSvrDataPath/gameconfig/PayGoods.csv
...
必须在bin目录下去执行restart.sh
vim /data/app/SGame/CommConfigData/SvrCommConf/AllSvrCommIncludeConf.conf
cd /data/app/SGame/OssServer/bin
...
# 功能
支付可以切换通道，如网银、扫码，每个通道可以设置上下限
queryDepositChannelStat
# 其他
...
##### 支付异步回调地址配置
/data/app/SGame/PayCenterServer/bin/PayCenterServer.conf 
AsyncRetNotifyBaseAddr
##### 配置用户充值价格等
/data/app/SGame/CommConfigData/GameSvrDataPath/gameconfig/PayGoodsDetail.csv
改了再重启所有 /data/app/SGame/TarsAdminTool/Restart_AllServer_InRightSequence.sh
...
##### 手动订单审核（系统也会自动审核）
cd /data/app/SGame/TinyGameBaseTool 
/data/app/SGame/TinyGameBaseTool/TinyGameBaseTool --order=50220141888 --pass=1
./TinyGameBaseTool confirmWithdraw --order=50324165646386 --pass=1
./TinyGameBaseTool confirmWithdraw --order=50324165646386 --pass=0
./TinyGameBaseTool confirmWithdraw --order=50916155442385 --pass=1
...
最开始是-O2
# 发布服务到线上
cd /data/app/SGame/PayCenterServer/bin
vim cq_PayPlatformConf.csv
...
cd /data/app/SGame/PayCenterServer/bin && ./restart.sh
/data/app/SGame/PayCenterServer/bin/restart.sh

修改cq_xxx.csv
b PayCenteLogic_Wrodpay::doRemoteOrLocalGenDepositOrder
